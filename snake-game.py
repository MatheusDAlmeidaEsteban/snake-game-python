...
x_bonus = randint(40, 600)
y_bonus = randint(50, 430)
pontos = 0
...
def reiniciar_jogo():
    global pontos, comprimento_inicial, x_cobra, y_cobra, lista_cobra, lista_cabeca, x_maca, y_maca, morte 
    pontos = 0
    comprimento_inicial = 5
    ...
    lista_cobra = []
    lista_cabeca = []
    x_maca = randint(80, 600)
    y_maca = randint(80, 420)
    morte  = False
